@echo off
set "backup_dir=C:\Users\lamr4\OneDrive\Escritorio\Pra-Backups-BD2\1.Backup-Logico\3"
...
echo El nombre del archivo será: BK_tipo3_%timestamp%.sql
pause

set "filename=BK_tipo3_%timestamp%.sql"
